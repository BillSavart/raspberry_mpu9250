...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QtCore.QRect(0, 0, 1821, 921))
        self.label.setText("")
        ...
        self.btn_choose.setGeometry(QtCore.QRect(1460, 920, 121, 61))
        self.btn_choose.setObjectName("btn_choose")
        self.btn_ok = QtWidgets.QPushButton(Form)
        self.btn_ok.setGeometry(QtCore.QRect(1620, 920, 121, 61))
